function params = lirnetDNase(expression, tf_expression, assign, DNasePairFeats, cellTypeMap, DNasePairWeights, num_mod, maxiters, reclust, l1Bounds, e)
...
%               types
%           DNasePairWeights: matrix of size hp, where hp is the number of
...
[nreg,nsamples] = size(tf_expression);
...
l1Upper = l1Bounds(1); % C0 in paper
l1Lower = l1Bounds(2); % C1 in paper
...
for rr = 1:reclust;
    ...
    obj = calculate_objectiveDNase ( modmean, tf_expression, assign, W, DNaseRel, cellTypeMap, DNasePairWeights, e );
    ...
    for iter = 1 : maxiters
        ...
        DNasePairWeights = learn_regul_metapriorDNase(DNasePairFeats, cellTypeMap, DNasePairWeights,W,assign, l1Upper,l1Lower,e);
...
params.DNasePairWeights = DNasePairWeights;
