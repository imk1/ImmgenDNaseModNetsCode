function crossValParams = lirnetCrossValDNase(expression, tf_expression, standReq, assign, DNasePairFeats, cellTypeMap, DNaseRel, num_mod, maxiters, reclust, l1Bounds, e, crossValFold)
...
if standReq == -1
    ...
    expression = expression - mean(expression, 2);
    tf_expression = tf_expression - mean(tf_expression, 2);
end
if standReq <= 0
...
for i = 1:crossValFold
    ...
    params = lirnetDNase(expressionTrain, tf_expressionTrain, assign, DNasePairFeats, cellTypeMap(trainSetIndexes), DNaseRel, num_mod, maxiters, reclust, l1Bounds, e);
