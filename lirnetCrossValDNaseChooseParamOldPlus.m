function crossValParams = lirnetCrossValDNaseChooseParam(expression, tf_expression, standReq, assign, DNasePairFeats, cellTypeMap, DNaseRel, num_mod, maxiters, reclust, l1UpperList, l1LowerList, e, crossValFold)
...
for j = 1:length(l1LowerList)
    ...
    for i = 1:length(l1UpperList)
        ...
        crossValParamsList{l1UpperCount} = lirnetCrossValDNase(expression, tf_expression, standReq, assign, DNasePairFeats, cellTypeMap, DNaseRel, num_mod, maxiters, reclust, l1Bounds, e, crossValFold);
